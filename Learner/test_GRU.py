...
def main_for_evaluation():
    pathname = "./model/ATT_GRU_model-7000"
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for line in reader:
                cnt += 1
                en1, en2, sentence = line[0], line[1], line[3]
                print("实体1: " + en1)
                print("实体2: " + en2)
                print(sentence)
                relation = 0
